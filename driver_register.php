    ...
    <ul class="form-section page-section">
        ...
        <div class="form-header-group">
          <div class="header-text httac htvam">
            <h3 id="header_28" class="form-header">
              PixselleEye Driver's Registration Form
            </h3>
          </div>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_30">
        ...
        <div id="cid_30" class="form-input jf-required">
          <input type="text" class=" form-textbox validate[required, Numeric]" data-type="input-textbox" id="input_30" name="q30_driversId" size="20" value="" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_31">
        ...
        <div id="cid_31" class="form-input jf-required">
          <input type="text" class=" form-textbox validate[required, Numeric]" data-type="input-textbox" id="input_31" name="q31_driversLicense" size="20" value="" />
        </div>
      </li>
      ...
      <li class="form-line" data-type="control_textbox" id="id_32">
        <label class="form-label form-label-left form-label-auto" id="label_32" for="input_32"> Age </label>
        <div id="cid_32" class="form-input jf-required">
          <input type="text" class=" form-textbox validate[Numeric]" data-type="input-textbox" id="input_32" name="q32_age" size="20" value="" />
        </div>
      </li>
      <li class="form-line" data-type="control_datetime" id="id_40">
        <label class="form-label form-label-left form-label-auto" id="label_40" for="input_40"> Date of Birth </label>
        <div id="cid_40" class="form-input jf-required">
          <span class="form-sub-label-container" style="vertical-align: top">
            <input class="form-textbox" id="month_40" name="q40_dateOf[month]" type="tel" size="2" maxlength="2" value="" />
            <span class="date-separate">
              &nbsp;-
            </span>
            <label class="form-sub-label" for="month_40" id="sublabel_month" style="min-height: 13px;"> Month </label>
          </span>
          <span class="form-sub-label-container" style="vertical-align: top">
            <input class="form-textbox" id="day_40" name="q40_dateOf[day]" type="tel" size="2" maxlength="2" value="" />
            <span class="date-separate">
              &nbsp;-
            </span>
            <label class="form-sub-label" for="day_40" id="sublabel_day" style="min-height: 13px;"> Day </label>
          </span>
          <span class="form-sub-label-container" style="vertical-align: top">
            <input class="form-textbox" id="year_40" name="q40_dateOf[year]" type="tel" size="4" maxlength="4" value="" />
            <label class="form-sub-label" for="year_40" id="sublabel_year" style="min-height: 13px;"> Year </label>
          </span>
          <span class="form-sub-label-container" style="vertical-align: top">
            <img class="showAutoCalendar" alt="Pick a Date" id="input_40_pick" src="https://d2g9qbzl5h49rh.cloudfront.net/images/calendar.png" align="absmiddle" />
            <label class="form-sub-label" for="input_40_pick" style="min-height: 13px;">  </label>
          </span>
        </div>
      </li>
      ...
      <li class="form-line" data-type="control_email" id="id_10">
        ...
        <div id="cid_10" class="form-input jf-required">
          <input type="email" class=" form-textbox validate[AlphaNumeric]" id="input_10" name="q10_email10" size="32" value="" />
        </div>
      </li>
      ...
      <li class="form-line" data-type="control_fileupload" id="id_37">
        <label class="form-label form-label-left form-label-auto" id="label_37" for="input_37">  </label>
        <div id="cid_37" class="form-input jf-required">
          <span class="form-sub-label-container" style="vertical-align: top">
            <input class="form-upload" type="file" id="input_37" name="q37_input37" file-accept="pdf, doc, docx, xls, xlsx, csv, txt, rtf, html, zip, mp3, wma, mpg, flv, avi, jpg, jpeg, png, gif" file-maxsize="3072" file-minsize="0" file-limit="0" />
            <label class="form-sub-label" for="input_37" style="min-height: 13px;"> Upload your Profile Picture </label>
          </span>
        </div>
      </li>
      <li class="form-line" data-type="control_widget" id="id_36">
        ...
        <div id="cid_36" class="form-input jf-required">
          <div style="width:100%; text-align:Left;">
            ...
            setTimeout(function()
{
  document.getElementById("widget_settings_36").value = "%5B%5D";
  var _cFieldFrame = document.getElementById("customFieldFrame_36");
  _cFieldFrame.src = "https://widgets.jotform.io/takephoto/?qid=36&ref=" + encodeURIComponent(window.location.protocol + "//" + window.location.host);
